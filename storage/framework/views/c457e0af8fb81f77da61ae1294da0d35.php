    ...
    <div class="w-full bg-white shadow flex flex-col my-4 p-6">
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('by-category', $category)); ?>"
               class="text-semibold block py-2 px-3 rounded <?php echo e(request('category')?->slug === $category->slug
...
<?php /**PATH F:\xampp\htdocs\blog\resources\views/components/sidebar.blade.php ENDPATH**/ ?>